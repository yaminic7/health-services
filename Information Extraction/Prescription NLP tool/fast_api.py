...
from predict import get_ner_predictions, get_biobert_ner_predictions
#get_re_predictions
...
@app.post("/get_IOB")
def get_ehr_predictions_IOB(ner_input: NERTask):
    """Request EHR text data and the model choice for NER Task"""

    # ner_predictions_index = get_ner_predictions_IOB(
    #     ehr_record=ner_input.ehr_text,
    #     model_name=ner_input.model_choice)

    ner_predictions,ner_predictions_index = get_ner_predictions(
        ehr_record=ner_input.ehr_text,
        model_name=ner_input.model_choice)
    ...
    return {'index_entity' : ner_predictions_index}
